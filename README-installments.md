...
This module enables customers to pay photographers over time using Stripe Subscription Schedules with automatic platform fee collection and Connect transfers.
...
2. **Stripe subscription created** → Customer is charged on schedule
3. **Platform fee deducted** → Automatically retained on your main Stripe account
4. **Photographer receives payout** → Transferred to their Stripe Connect account
5. **Webhooks update status** → Real-time tracking of payment success/failure
