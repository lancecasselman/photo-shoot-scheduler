...
The platform now includes a complete website publishing infrastructure that allows photographers to publish their created websites to subdomains (photographer.photomanagerpro.com). The system features:
